    ...
    class Task1 extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            try {
                ...
                //Enviamos respuesta al servidor con el usuario y contraseña
            ...
            //Captura una excepción cuando no tenemos conexión con el servidor, pero le lleva tiempo mostrarla
            } catch (IOException e) {
        ...
        protected void onPostExecute(String s) {
            ...
            if (resposta_id != 0) {
                ...
                if (resposta_rol == 3) {
                    ...
                    Intent intent = new Intent(MainActivity.this, PantallaMenuPrincipal.class);
